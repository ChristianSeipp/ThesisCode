...
class WaveSolver2D:
    ...
    def __init__(self,xdomains, ydomains,f,g,c,dt,bcs):
        ...
        self.numBlocks_  = (self.minSize_*self.nDomains,self.nDomains)
    ...
    def timeStep(self):
        ...
        for subDomain in range(self.nDomains_):
            for subDomain2 in range(self.nDomains_):
                ...
                hUValsMatrix[xindex1:xindex2,yindex1:yindex2,self.minSize_] = segment.ucurr_ 
                hUPrevMatrix[xindex1:xindex2,yindex1:yindex2,self.minSize_] = segment.uprev_ 
                ...
                hvjInvList[xindex1:xindex2,yindex1:yindex2] = 1/segment.getVJ('x')**2
        ...
        dJSizeList  = cuda.to_device(hJSize)
        ...
        for subDomain in range(self.nDomains_):
            ...
            hxvals_[:,yindex1:yindex2] = segment.xvals_
